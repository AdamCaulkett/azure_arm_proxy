...
const (
	listNSGsResponse   = `{"value": [{"etag":"W/\"3d45798e-89d0-4c9b-a65d-eecf2b44e6f6\"","href":"resource_groups/Group-1/network_security_groups/khrvi1","id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1","location":"westus","name":"khrvi1","properties":{"defaultSecurityRules":[{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowVnetInBound","name":"AllowVnetInBound","properties":{"access":"Allow","description":"Allow inbound traffic from all VMs in VNET","destinationAddressPrefix":"VirtualNetwork","destinationPortRange":"*","direction":"Inbound","priority":65000,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"VirtualNetwork","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowAzureLoadBalancerInBound","name":"AllowAzureLoadBalancerInBound","properties":{"access":"Allow","description":"Allow inbound traffic from azure load balancer","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Inbound","priority":65001,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"AzureLoadBalancer","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/DenyAllInBound","name":"DenyAllInBound","properties":{"access":"Deny","description":"Deny all inbound traffic","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Inbound","priority":65500,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowVnetOutBound","name":"AllowVnetOutBound","properties":{"access":"Allow","description":"Allow outbound traffic from all VMs to all VMs in VNET","destinationAddressPrefix":"VirtualNetwork","destinationPortRange":"*","direction":"Outbound","priority":65000,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"VirtualNetwork","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowInternetOutBound","name":"AllowInternetOutBound","properties":{"access":"Allow","description":"Allow outbound traffic from all VMs to Internet","destinationAddressPrefix":"Internet","destinationPortRange":"*","direction":"Outbound","priority":65001,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/DenyAllOutBound","name":"DenyAllOutBound","properties":{"access":"Deny","description":"Deny all outbound traffic","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Outbound","priority":65500,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}}],"provisioningState":"Succeeded"}},{"etag":"W/\"f16517fd-a1f6-449d-a77c-06ef63318423\"","href":"resource_groups/Group-1/network_security_groups/khrvi2","id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2","location":"westus","name":"khrvi2","properties":{"defaultSecurityRules":[{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/defaultSecurityRules/AllowVnetInBound","name":"AllowVnetInBound","properties":{"access":"Allow","description":"Allow inbound traffic from all VMs in VNET","destinationAddressPrefix":"VirtualNetwork","destinationPortRange":"*","direction":"Inbound","priority":65000,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"VirtualNetwork","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/defaultSecurityRules/AllowAzureLoadBalancerInBound","name":"AllowAzureLoadBalancerInBound","properties":{"access":"Allow","description":"Allow inbound traffic from azure load balancer","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Inbound","priority":65001,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"AzureLoadBalancer","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/defaultSecurityRules/DenyAllInBound","name":"DenyAllInBound","properties":{"access":"Deny","description":"Deny all inbound traffic","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Inbound","priority":65500,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/defaultSecurityRules/AllowVnetOutBound","name":"AllowVnetOutBound","properties":{"access":"Allow","description":"Allow outbound traffic from all VMs to all VMs in VNET","destinationAddressPrefix":"VirtualNetwork","destinationPortRange":"*","direction":"Outbound","priority":65000,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"VirtualNetwork","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/defaultSecurityRules/AllowInternetOutBound","name":"AllowInternetOutBound","properties":{"access":"Allow","description":"Allow outbound traffic from all VMs to Internet","destinationAddressPrefix":"Internet","destinationPortRange":"*","direction":"Outbound","priority":65001,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/defaultSecurityRules/DenyAllOutBound","name":"DenyAllOutBound","properties":{"access":"Deny","description":"Deny all outbound traffic","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Outbound","priority":65500,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}}],"provisioningState":"Succeeded","securityRules":[{"etag":"W/\"f16517fd-a1f6-449d-a77c-06ef63318423\"","id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi2/securityRules/khrvi2_1","name":"khrvi2_1","properties":{"access":"Allow","description":"test","destinationAddressPrefix":"*","destinationPortRange":"800","direction":"Inbound","priority":100,"protocol":"Tcp","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"800"}}]}}]}`
	listOneNSGResponse = `{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1","name":"khrvi1","location":"westus","etag":"W/\"3d45798e-89d0-4c9b-a65d-eecf2b44e6f6\"","properties":{"defaultSecurityRules":[{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowVnetInBound","name":"AllowVnetInBound","properties":{"access":"Allow","description":"Allow inbound traffic from all VMs in VNET","destinationAddressPrefix":"VirtualNetwork","destinationPortRange":"*","direction":"Inbound","priority":65000,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"VirtualNetwork","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowAzureLoadBalancerInBound","name":"AllowAzureLoadBalancerInBound","properties":{"access":"Allow","description":"Allow inbound traffic from azure load balancer","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Inbound","priority":65001,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"AzureLoadBalancer","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/DenyAllInBound","name":"DenyAllInBound","properties":{"access":"Deny","description":"Deny all inbound traffic","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Inbound","priority":65500,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowVnetOutBound","name":"AllowVnetOutBound","properties":{"access":"Allow","description":"Allow outbound traffic from all VMs to all VMs in VNET","destinationAddressPrefix":"VirtualNetwork","destinationPortRange":"*","direction":"Outbound","priority":65000,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"VirtualNetwork","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/AllowInternetOutBound","name":"AllowInternetOutBound","properties":{"access":"Allow","description":"Allow outbound traffic from all VMs to Internet","destinationAddressPrefix":"Internet","destinationPortRange":"*","direction":"Outbound","priority":65001,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}},{"id":"/subscriptions/test/resourceGroups/Group-1/providers/Microsoft.Network/networkSecurityGroups/khrvi1/defaultSecurityRules/DenyAllOutBound","name":"DenyAllOutBound","properties":{"access":"Deny","description":"Deny all outbound traffic","destinationAddressPrefix":"*","destinationPortRange":"*","direction":"Outbound","priority":65500,"protocol":"*","provisioningState":"Succeeded","sourceAddressPrefix":"*","sourcePortRange":"*"}}],"provisioningState":"Succeeded"},"href":"resource_groups/Group-1/network_security_groups/khrvi1"}`
)
